export const TRANSLATIONS = {
	...
	it: {
		...
		aboutContent: [
			...
			'Prima, in una piccola azienda d\'eccellenza, lavorando su customizzazioni di soluzioni Open Source in un contesto Agile ed utilizzando pratiche di sviluppo come XP e TDD. In seguito, e per i successivi 7 anni, nel settore IT di un grande gruppo bancario italiano, in un contesto internazionale e enterprise, cambiando dipartimenti e progetti ed evolvendo molto come professionista. ',
