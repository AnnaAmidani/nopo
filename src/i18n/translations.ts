export const TRANSLATIONS = {
	en: {
		...
		aboutContent: [
			...
			'First, at a small but excellent company, working on customisations of Open Source solutions in an Agile environment and using development practices such as XP and TDD. Then, for the next 7 years, I worked in IT at a major Italian Banking Group: crossing departments, shifting projects, and growing steadily across an international, enterprise-scale environment.',
