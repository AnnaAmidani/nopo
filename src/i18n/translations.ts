export const TRANSLATIONS = {
	en: {
		...
		aboutContent: [
			...
			'First, at a small but excellent company, cutting my teeth on customisations of Open Source solutions in an Agile environment and using development practices such as XP and TDD. Then, for the following 7 years, in the IT department of a large Italian Banking Group, in an international and enterprise context, changing departments and projects and growing a lot as a professional. ',
			'The history and character of my home region are part of my cultural and personal makeup at various levels - conscious and unconscious - rediscovered, appreciated, and better understood after embarking on what has now become a decade-long international journey, which has taken me, through various changes of companies and roles, to Ireland, Great Britain, and Canada. ',
	...
	it: {
		...
		aboutContent: [
			...
			'Prima, in una piccola azienda d\'eccellenza, facendomi le ossa su customizzazioni di soluzioni Open Source in un contesto Agile ed utilizzando pratiche di sviluppo come XP e TDD. In seguito, e per i successivi 7 anni, nel settore IT di un grande gruppo bancario italiano, in un contesto internazionale e enterprise, cambiando dipartimenti e progetti ed evolvendo molto come professionista. ',
